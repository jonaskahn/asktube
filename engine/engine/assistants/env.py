...
AUDIO_CHUNK_CHAPTER_DURATION: int = int(os.getenv("AT_AUDIO_CHUNK_CHAPTER_DURATION", 300))
QUERY_SIMILAR_THRESHOLD: float = float(os.getenv("AT_QUERY_SIMILAR_THRESHOLD", 0.5))
TOKEN_CONTEXT_THRESHOLD: int = int(os.getenv("AT_TOKEN_CONTEXT_THRESHOLD", 2048))
AUDIO_ENHANCE_ENABLED: str = os.getenv("AT_AUDIO_ENHANCE_ENABLED", "no")
...
LOCAL_EMBEDDING_DEVICE = os.getenv("AT_LOCAL_EMBEDDING_DEVICE", "cpu")
...
LOCAL_WHISPER_DEVICE = os.getenv("AT_LOCAL_WHISPER_DEVICE", "cpu")
