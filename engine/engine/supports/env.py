...
APP_DIR = os.path.abspath(
    os.getenv("AT_APP_DIR", os.path.join(tempfile.gettempdir(), "asktube"))
)
LANGUAGE_PREFER_USAGE: str = os.getenv("AT_LANGUAGE_PREFER_USAGE", "en")
AUDIO_CHUNK_RECOGNIZE_DURATION: int = int(
    os.getenv("AT_AUDIO_CHUNK_RECOGNIZE_DURATION", 30)
)
AUDIO_CHUNK_RECOGNIZE_THRESHOLD: int = int(
    os.getenv("AT_AUDIO_CHUNK_RECOGNIZE_THRESHOLD", 120)
)
AUDIO_CHUNK_CHAPTER_DURATION: int = int(
    os.getenv("AT_AUDIO_CHUNK_CHAPTER_DURATION", 600)
)
QUERY_SIMILAR_THRESHOLD: float = float(os.getenv("AT_QUERY_SIMILAR_THRESHOLD", 0.2))
...
GEMINI_EMBEDDING_MODEL = os.getenv(
    "AT_GEMINI_EMBEDDING_MODEL", "models/text-embedding-004"
)
OPENAI_EMBEDDING_MODEL = os.getenv(
    "AT_OPENAI_EMBEDDING_MODEL", "text-embedding-ada-002"
)
...
LOCAL_EMBEDDING_MODEL = os.getenv(
    "AT_LOCAL_EMBEDDING_MODEL", "intfloat/multilingual-e5-base"
)
